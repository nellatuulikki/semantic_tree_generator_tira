...
class SemanticTreeNode:
    def __init__(self, proposition, left_child=None):
        ...
        self.proposition_string = PropositionParser().
        self.checked = False
    ...
    def generate_childs(self, proposition):
        proposition_list, main_connective, negation = PropositionParser().split_proposition(proposition)
    ...
    def insert_children_conjunction(self, proposition_list, negation):
        if negation:
            ...
            self.left_child = SemanticTreeNode(negation_left)
            self.right_child = SemanticTreeNode(negation_right)
